 ...
 *
 * Bridge pattern: Suite-specific validation adapted from dao-suite.
 * Uses admin-suite route prefixes for validation.
 */

/**
 * Allowed path prefixes for redirects.
 * Only paths starting with these prefixes are considered valid.
 * Updated to match actual dao-admin-suite routes from App.tsx.
 */
